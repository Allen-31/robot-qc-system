...
| **operation-notification** | 异常通知、登录/操作/API 日志 | `/api/operation/exception-notifications`、`/api/operation/logs/*` | `controller.operation.notification` | 📁 已建包，待开发 |
...
│   │   ├── notification        # operation-notification（待开发）
...
| 运营 → 异常通知 / 日志 | operation-notification |
...
| **操作日志** | common 或 operation-notification | 可落库或写日志中心，由 operation-notification 或公共切面统一记录 |
